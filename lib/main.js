...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const labels = JSON.parse(isIssue ? issueLabels : prLabels);
            console.log(labels);
...
const isFirstIssue = (client, owner, repo, sender, curIssueNumber) => __awaiter(void 0, void 0, void 0, function* () {
